...
function ocrProcessing(file){
    ...
    https.get('https://api.hearthstonejson.com/v1/28855/enUS/cards.collectible.json', (resp) => {
        let data = '';
        let deck = [];
        ...
        resp.on('end', () => {
            ...
            // Teeseract does the actual OCR for the decklist
...
module.exports.ocrProcessing = ocrProcessing;